...
def gen_features(state,idteam,idplayer):
    ...
    return [(e_p-p).norm,#enemie proche ou pas
            min((b_p-p).norm,(b_p-a_p).norm),#quelqu'un a la ball ou pas                 
            ]
    
gen_features.names = ["enemie proche","quelqu'un a la ball ou pas"]
